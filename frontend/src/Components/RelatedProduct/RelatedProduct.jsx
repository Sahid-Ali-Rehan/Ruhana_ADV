      ...
      <div className="w-full py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <div className="h-8 w-64 bg-gray-100 animate-pulse rounded"></div>
            <div className="h-8 w-32 bg-gray-100 animate-pulse rounded"></div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="h-64 bg-gray-100 animate-pulse rounded-t-xl"></div>
                <div className="p-4">
                  <div className="h-6 w-3/4 bg-gray-200 animate-pulse mb-2 rounded"></div>
                  <div className="h-4 w-1/2 bg-gray-200 animate-pulse mb-4 rounded"></div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link 
            ...
            className="text-lg font-semibold flex items-center hover:underline text-blue-600" 
          >
            View All
            ...
            return (
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  ...
                  {product.discount > 0 && (
                    <motion.div 
                      className="absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-bold shadow-md bg-blue-100 text-blue-800"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                ...
                <Link to={`/products/single/${product._id}`}>
                  <div className="p-4 bg-white">
                    ...
                    <div className="flex items-center mt-3">
                      ...
                      {product.discount > 0 && (
                        <p className="ml-2 line-through text-sm text-gray-500">
